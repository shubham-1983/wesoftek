...
class OfficeRelocation extends StatefulWidget {
  @override
  _OfficeRelocationState createState() => _OfficeRelocationState();
}

class _OfficeRelocationState extends State<OfficeRelocation> {
  String movingFrom = " ";
  String movingTo = " ";
    ...
    return Scaffold(
      ...
      body: Container(
        ...
        child: Column(
          ...
          children: [
            TextField(
              decoration: InputDecoration(labelText: 'Location of Current Office',
            ...
            TextField(
              decoration: InputDecoration(labelText: 'Location of New Office',
                  border: OutlineInputBorder(
                      borderRadius: BorderRadius.circular(20),
                      borderSide: BorderSide(
                        color: Colors.black87,
